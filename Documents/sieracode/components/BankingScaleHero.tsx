...
const stats: StatItem[] = [
  {
    value: "5",
    description: "David, Guillermo, Jesús\nSaúl, José - ISC 7°",
    delay: 0,
  },
  {
    value: "3er",
    description: "Lugar Nacional\nHackaTecNM 2025",
    delay: 0.2,
  },
  {
    value: "48h",
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Impulsando el talento tecnológico en Zongolica{" "}
              <span
              ...
              >
                desde el Instituto Tecnológico Superior de Zongolica hacia competencias nacionales.
              </span>
            </h2>
            ...
            >
              Somos una comunidad de estudiantes que desarrolla soluciones tecnológicas reales, participa en competencias
              nacionales y genera oportunidades para jóvenes de la región.
            </p>
