...
const defaultSections: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Apps Móviles", href: "#mobile" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Competencias", href: "#competitions" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Ubicación ITSZ", href: "#location" },
      { label: "Redes Sociales", href: "#social" },
      { label: "Patrocinios", href: "#sponsor" },
      { label: "FAQ", href: "#faq" },
    ],
  },
]
...
export const Footer = ({
  companyName = "Siera Code",
  tagline = "Comunidad Tecnológica Estudiantil ITSZ",
  sections = defaultSections,
  socialLinks = {
    twitter: "https://twitter.com",
    linkedin: "https://linkedin.com",
    github: "https://github.com",
    email: "sieracode@itsz.edu.mx",
  },
  copyrightText,
}: FooterProps) => {
