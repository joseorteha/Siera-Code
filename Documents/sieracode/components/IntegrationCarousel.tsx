...
export const IntegrationCarousel = ({
  ...
  buttonHref = "#",
  title = "Stack Tecnológico Moderno y Versátil",
  subtitle = "React, Next.js, Node.js, Python, Java, TypeScript, Tailwind CSS, PostgreSQL, MongoDB, Docker, AWS y más. Experiencia full-stack para proyectos escalables.",
